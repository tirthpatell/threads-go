...
// ValidateTextAttachment validates text attachment structure and content (added October 2025)
...
// ValidateTextEntities validates text spoiler entities (added October 2025)
