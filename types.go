...
type TextPostContent struct {
	...
	// TextEntities marks specific text ranges as spoilers (added October 2025)
	...
	// TextAttachment allows adding longer text content with styling (added October 2025)
...
type ImagePostContent struct {
	...
	// Max 10 entities per post. Each entity specifies offset and length of spoiler text.
	TextEntities []TextEntity `json:"text_entities,omitempty"`
	// IsSpoilerMedia marks the image as a spoiler (added October 2025)
...
type VideoPostContent struct {
	...
	// Max 10 entities per post. Each entity specifies offset and length of spoiler text.
	TextEntities []TextEntity `json:"text_entities,omitempty"`
	// IsSpoilerMedia marks the video as a spoiler (added October 2025)
	IsSpoilerMedia bool `json:"is_spoiler_media,omitempty"`
}
...
type CarouselPostContent struct {
	...
	// Max 10 entities per post. Each entity specifies offset and length of spoiler text.
	TextEntities []TextEntity `json:"text_entities,omitempty"`
	// IsSpoilerMedia marks ALL carousel media (images/videos) as spoilers (added October 2025)
	IsSpoilerMedia bool `json:"is_spoiler_media,omitempty"`
}
...
// TextEntity represents a spoiler entity within text content (added October 2025)
...
// TextAttachment represents a text attachment with optional styling (added October 2025)
